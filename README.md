...
> Simple, real-time queue management for restaurants.

---

## Overview

Restaurants struggle with inefficient queue systems that frustrate customers and reduce turnover.
...
services:
  - name: api
    github:
      repo: Two-Weeks-Team/queueflow-lite
      branch: master
